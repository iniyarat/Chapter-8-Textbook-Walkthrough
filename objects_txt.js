...
/* Object definign the poker game*/
let pokerGame={
   currentBank: null,
   currentBet: null,
   placeBet: function(){
...
/* Methods to reference the image source file for a card */
pokerCard.prototype.cardImage = function(){
   return this.rank + "_" + this.suit + ".png";
};
/*Contstructor function for poker decks*/
function pokerDeck(){
   ...
   // Method to deal cards from decl into a hand
...
// Method to replace a card with a hand with a card ffrom a deck
